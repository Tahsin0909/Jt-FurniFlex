                    ...
                    <div className="grid lg:grid-cols-3 grid-cols-1 gap-gap_primary">
                        <div className="lg:col-span-2">
                            ...
                            <div className='space-y-5 pt-5'>
                                ...
                                <div className="">
                                    <h4 className='pt-8 mb-4 text-[18px] 
                                    font-bold'>ADDITIONAL INFORMATION</h4>
                                    <div className="flex flex-col space-y-1 border p-input_padding focus-within:border-primary rounded-rounded_primary bg-white">
                        ...
                        p-[30px] mt-10 lg:mt-0 rounded-rounded_primary">
                            ...
                            <div className="flex items-center justify-between">
                                <p className='text-[13.6px] py-[6.8px]'>Shipping</p>
                                <p className='text-[13.6px] py-[6.8px]'>FREE</p>
                            </div>
            ...
            <dialog id="orderConfirm">
                <div
                    ...
                    <div className="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 relative">
                        <button
                            onClick={() => document.getElementById('orderConfirm').close()}
                        ...
                        <div className="my-8 text-center">
                            ...
                            <div className="grid grid-cols-3 gap-4 mt-6">
                                ...
                                <div className="flex items-start justify-start  gap-1 col-span-2 w-fit">
                                    ...
                                    <p className="text-gray-700 text-start font-medium break-words overflow-hidden text-ellipsis">
                                        {address}
                                    </p>
                                </div>
                        ...
                        <button onClick={() => document.getElementById('orderConfirm').close()}
